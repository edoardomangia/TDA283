...
/********************   LhsVar    ********************/
LhsVar::LhsVar(Ident p1)
{
  ident_ = p1;

}

LhsVar::LhsVar(const LhsVar & other)
{
  ident_ = other.ident_;

}

LhsVar &LhsVar::operator=(const LhsVar & other)
{
  LhsVar tmp(other);
  swap(tmp);
  return *this;
...
void LhsVar::accept(Visitor *v)
{
  v->visitLhsVar(this);
}

LhsVar *LhsVar::clone() const
{
  return new LhsVar(*this);
}



/********************   LhsIndex    ********************/
LhsIndex::LhsIndex(Expr *p1, Expr *p2)
{
  expr_1 = p1;
  expr_2 = p2;
...
LhsIndex::LhsIndex(const LhsIndex & other)
{
...
LhsIndex &LhsIndex::operator=(const LhsIndex & other)
{
  LhsIndex tmp(other);
  swap(tmp);
  return *this;
...
void LhsIndex::swap(LhsIndex & other)
{
...
void LhsIndex::accept(Visitor *v)
{
  v->visitLhsIndex(this);
}

LhsIndex *LhsIndex::clone() const
{
  return new LhsIndex(*this);
}
...
IntBase::IntBase(const IntBase & other)
{

}

IntBase &IntBase::operator=(const IntBase & other)
{
  IntBase tmp(other);
  swap(tmp);
  return *this;
...
void IntBase::swap(IntBase & other)
{
...
void IntBase::accept(Visitor *v)
{
  v->visitIntBase(this);
}

IntBase *IntBase::clone() const
{
  return new IntBase(*this);
}
...
DoubBase::DoubBase(const DoubBase & other)
{

}

DoubBase &DoubBase::operator=(const DoubBase & other)
{
  DoubBase tmp(other);
  swap(tmp);
  return *this;
...
void DoubBase::swap(DoubBase & other)
{
...
void DoubBase::accept(Visitor *v)
{
  v->visitDoubBase(this);
}

DoubBase *DoubBase::clone() const
{
  return new DoubBase(*this);
}
...
BoolBase::BoolBase(const BoolBase & other)
{

}

BoolBase &BoolBase::operator=(const BoolBase & other)
{
  BoolBase tmp(other);
  swap(tmp);
  return *this;
...
void BoolBase::swap(BoolBase & other)
{
...
void BoolBase::accept(Visitor *v)
{
  v->visitBoolBase(this);
}

BoolBase *BoolBase::clone() const
{
  return new BoolBase(*this);
}
...
/********************   ENew    ********************/
ENew::ENew(BaseType *p1, ListArrSize *p2)
{
  basetype_ = p1;
  listarrsize_ = p2;
...
ENew::ENew(const ENew & other)
{
  basetype_ = other.basetype_->clone();
  listarrsize_ = other.listarrsize_->clone();

}

ENew &ENew::operator=(const ENew & other)
{
  ENew tmp(other);
  swap(tmp);
  return *this;
...
void ENew::swap(ENew & other)
{
  std::swap(basetype_, other.basetype_);
  std::swap(listarrsize_, other.listarrsize_);
...
void ENew::accept(Visitor *v)
{
  v->visitENew(this);
}

ENew *ENew::clone() const
{
  return new ENew(*this);
}
...
/********************   ELength    ********************/
ELength::ELength(Expr *p1, Ident p2)
{
  expr_ = p1;
  ident_ = p2;
...
ELength::ELength(const ELength & other)
{
  expr_ = other.expr_->clone();
  ident_ = other.ident_;
...
ELength &ELength::operator=(const ELength & other)
{
  ELength tmp(other);
  swap(tmp);
  return *this;
...
void ELength::swap(ELength & other)
{
  std::swap(expr_, other.expr_);
  std::swap(ident_, other.ident_);
...
void ELength::accept(Visitor *v)
{
  v->visitELength(this);
}

ELength *ELength::clone() const
{
  return new ELength(*this);
}
...
/********************   NewDim    ********************/
NewDim::NewDim(Expr *p1)
{
  expr_ = p1;

}

NewDim::NewDim(const NewDim & other)
{
  expr_ = other.expr_->clone();

}

NewDim &NewDim::operator=(const NewDim & other)
{
  NewDim tmp(other);
  swap(tmp);
  return *this;
...
void NewDim::accept(Visitor *v)
{
  v->visitNewDim(this);
}

NewDim *NewDim::clone() const
{
  return new NewDim(*this);
}
...
void ListArrSize::accept(Visitor *v)
{
  v->visitListArrSize(this);
}

ListArrSize *ListArrSize::clone() const
{
  return new ListArrSize(*this);
}

ListArrSize* consListArrSize(ArrSize* x, ListArrSize* xs) {
  xs->insert(xs->begin(), x);
  return xs;
}
